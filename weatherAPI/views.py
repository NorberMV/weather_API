...
def weather_detail(request):                                
    ...
    serializer = WeatherSerializer(data=request.GET)          # Call to serializer WeatherSerializer() model  
    ...
    cache.set("{}-{}".format(country, city), weather_data, timeout=60*2)  # Storing the object in the cahe table
